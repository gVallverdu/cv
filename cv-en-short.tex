...
\begin{itemize}
\item For the client L'Oréal Au sein de l’équipe Data de la R\&D L’Oréal, accompagnement technique visant à faciliter la migration de l’infrastructure de données et les modèles d’apprentissage automatisé depuis des clusters locaux, on-premise, vers le cloud GCP.
\end{itemize}

\divider

\cvevent{Data Engineer/Scientist and instructor}{Lincoln}{2019 -- 2020}{Île de France, France}
\begin{itemize}
\item Malakoff Humanis Au sein de l’équipe de la DSI, accompagnement technique visant à faciliter la migration
...
\item Orange Au sein de l’équipe de Marketing Grand Public, migration d’un datamart développé sous
...
\begin{itemize}
\item Essilor Au sein de la direction technique, automatisation de mise à disposition de gros volume de
