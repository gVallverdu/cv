...
\personalinfo{%
  ...
  %\vspace{1ex}
  \printinfo{Marital status}{Domestic partnership}
  %\vspace{1ex}
...
\cvevent{Data Engineer/Analyst and instructor}{Lincoln/Alten}{2019 -- 2020}{Île de France, France}
\begin{itemize}
\justifying
...
\cvevent{Postdoctoral researcher}{UPMC/CNRS}{2014 -- 2016}{Paris, France}
\begin{itemize}
\justifying
